"""
Django settings for interpunct project.
...
SECRET_KEY = ')=&zs!opq7krx1bsh5l5sub!rl6gx#k-+7+bof6@x@p94$2oh$'
...
WSGI_APPLICATION = 'interpunct.wsgi.application'
